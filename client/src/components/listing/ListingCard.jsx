  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3">
        <div
          className="
            w-10 h-10 rounded-xl bg-saffron-50
      ...
      <div className="flex gap-2 pt-1 border-t border-gray-100">
        <a
          ...
          className="
            flex-1 text-center text-xs font-medium text-saffron-600
        ...
        <Link
          ...
          className="
            flex-1 text-center text-xs font-medium text-gray-600
        ...
        <button
          ...
          className="
            flex-1 text-center text-xs font-medium text-red-500
