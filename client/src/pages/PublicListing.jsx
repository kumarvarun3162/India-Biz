    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm mb-6">
        <div className="flex items-start gap-4 mb-5">
          <div className="w-14 h-14 rounded-2xl bg-saffron-50 flex items-center justify-center text-3xl flex-shrink-0">
            {icon}
          </div>
        ...
        <div className="flex gap-3 flex-wrap">
          ...
          {listing.website && (
            <a
              ...
              className="flex items-center justify-center gap-2 px-5 py-3 border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition-colors"
            >
              🌐 Website
            </a>
          )}
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm mb-6">
        <h2 className="font-semibold text-gray-800 mb-4 text-sm uppercase tracking-wide text-gray-400">
          Contact
        </h2>
